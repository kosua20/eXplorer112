...
UniformBufferBase::UniformBufferBase(size_t sizeInBytes, int updateFrequency, const std::string& name) : Buffer(BufferType::UNIFORM, name), _baseSize(sizeInBytes)
{
	// Number of instances of the buffer stored internally, based on usage.
	int multipler = updateFrequency;
